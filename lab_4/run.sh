...
Kubectl apply -f lab_4/infra/deployment-redis.yaml -n w255
Kubectl apply -f lab_4/infra/service-redis.yaml -n w255
Kubectl apply -f lab_4/infra/deployment-pythonapi.yaml -n w255
Kubectl apply -f lab_4/infra/service-prediction.yaml -n w255
sleep 40
